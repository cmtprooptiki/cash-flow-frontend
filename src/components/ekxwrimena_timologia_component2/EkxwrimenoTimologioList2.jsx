...
const EkxwrimenoTimologioList2 = () => 
{
    ...
    return(
        ...
        {user && user.role ==="admin" && (
        <Link to={"/ek_tim2/add"} className='button is-primary mb-2'><Button label="Προσθήκη Νέου Εκχωρημένου Τιμολογίου" icon="pi pi-plus-circle"/></Link>
        )}
...
export default EkxwrimenoTimologioList2;