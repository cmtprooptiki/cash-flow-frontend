...
<div className="card" >
        ...
        {user && user.role ==="admin" && (
        <Link to={"/ypoquery2/add"} className='button is-primary mb-2'><Button label="Προσθήκη Νέας Υποχρέωσης" icon="pi pi-plus-circle"/></Link>
        )}
...
export default YpoxreoseisList2